const Hero = () => {
  return (
    <main className="min-h-screen pt-16 pb-12 hero-gradient relative" id="home">
      ...
      <section className="container mx-auto px-6 min-h-[calc(100vh-112px)] flex items-center justify-center py-16 md:py-0">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full max-w-7xl mt-8 md:mt-0">
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-end justify-center relative">
            <div className="relative group mt-8 md:mt-0">
              ...
              <img alt="Lead Hero Avatar" className="w-48 sm:w-64 lg:w-96 aspect-square object-cover border-4 border-[#e9c349] shadow-[15px_15px_0px_0px_rgba(0,35,103,1)] animate-float" src="/kazukid1.jpg" />
            </div>
          </div>

          {/* Text & Commands Area */}
          <div className="lg:col-span-7 space-y-6 md:space-y-8 lg:pl-12 text-center lg:text-left">
            <div className="space-y-2">
              <h2 className="text-[#e9c349] font-headline font-bold text-sm md:text-xl tracking-[0.3em] uppercase opacity-80">STORY SO FAR...</h2>
              <h1 className="text-5xl sm:text-6xl md:text-8xl font-headline font-extrabold text-white leading-none tracking-tighter">HERO'S JOURNEY</h1>
              <p className="text-[#b4c5ff] text-sm md:text-xl font-headline font-medium tracking-wide">MOHAMMAD RIVALDY YUSUP / NEW DEV</p>
            </div>
